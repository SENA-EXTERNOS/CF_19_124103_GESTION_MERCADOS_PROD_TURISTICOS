  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5
    ...
    .row.mb-5.justify-content-center.align-items-center.align-items-lg-stretch
      ...
      .col-12.col-md-8.col-lg-9
        ...
        p El objetivo de esta actividad es evaluar el nivel de interiorización de los temas sobre la ejecución de eventos. 
        p.mb-5 Entre las opciones presentadas, seleccione la respuesta correcta.
